...
public fun Optimizely.getAllExperiments(): List<Experiments<out BaseVariation>> =
...
public sealed class Experiments<V : BaseVariation>(
  ...
  public object MyFeatureTest : Experiments<MyFeatureTestVariations>("my_feature_test",
